...
def run():
    ...
    model_path = "output/model_rnn_policy_3_layer_128_hidden"
    ...
    policy = Policy(action_space=action_space, state_space=state_space, dropout_rate=0.6, gamma=gamma, hidden_size=hidden_size, n_layers=n_layers)
